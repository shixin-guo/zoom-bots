...
const promptTemplate =
  `You are an expert translator in all languages. Translate the wording from {inputLanguage} to {outputLanguage}.
    do not write explanations,do not replace any placeholder and any html tag with anything.
    ...
    output should be Chinese and equal to: recording.management.download_video = 下载视频（MP4）
