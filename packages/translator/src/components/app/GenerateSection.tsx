  ...
  return (
    <>
      ...
      <div className="mb-12 mt-8 flex flex-col items-start gap-8 xl:mb-60 xl:flex-row xl:justify-between xl:gap-0">
          ...
          <div className="flex flex-col">
            <div className="relative">
              <textarea
                ...
                className="body border-slate-6 bg-slate-2 placeholder:text-slate-9 w-full resize-none rounded-[4px] border  p-6"
              />
        ...
        <div className="border-slate-6 bg-slate-2 h-64 w-full rounded-[4px] border p-10 xl:h-[384px] xl:w-[640px]">
          {completion ? (
