...
import { SignUpButton } from '@/app/(3_pricing)/_components';
      ...
      <div className="mt-16 flex flex-col items-center gap-4">
        <div className="flex">
          <Link
            ...
            className="caption-s border-slate-7 bg-slate-3 text-slate-12 hover:border-slate-8 hover:bg-slate-4 flex items-center gap-1 rounded-l-[4px] border px-2 py-[2px] font-medium"
          >
            <GitHubIcon className="fill-slate-12 h-5 w-5" />
            <span className="">Star</span>
          </Link>
          <Link
            href="https://github.com/tierrun/tier-vercel-openai/stargazers"
            className="border-slate-7 hover:bg-slate-2 group rounded-r-[4px] border-y border-r px-2 py-[2px]"
          >
            <span className="caption-s text-slate-12 group-hover:text-crimson-9 font-medium">
        ...
        <p className="body-xl text-slate-11 px-4 text-center md:w-[572px] md:px-0">
